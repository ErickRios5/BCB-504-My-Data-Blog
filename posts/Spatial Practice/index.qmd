...
# # Load data
# map_data <- st_read(system.file("shape/nc.shp", package="sf"))
...
gg_animated <- p + transition_states(id, state_length = 1, wrap = TRUE) +
  labs(title = "Malaria Prevalence by Country: {closest_state}") +
  enter_fade() + exit_fade()

# Save the animation as a GIF file
animate(gg_animated, "animated_plot.gif", fps = 10, width = 800, height = 500)
