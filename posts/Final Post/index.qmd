...
Preliminary network analysis reveals the cellular processes (Circle nodes) most likely affected by at least one Hsc82 mutation are related to metabolism and energy production, as well as stress responses such as oxidative and heat. When protein members of these cellular process that were affected in our study are examined, we can see that each process contains known physical (Yellow squares) and genetic (purple squares) interactors of Hsp90. The abundance of Hsp90 interactors in these processes builds confidence mutations in the chaperone are influencing these cellular process, likely through the interaction with the protein being altered, of which the protein may actually be a client, but follow-up studies would be required to determine client-hood.

In regards to individual mutants, W296A has the most edges or links to proteins involved in all 5 processes, suggesting this mutation is devastating to Hsp90 function and thus impacts the activity of these processes significantly. Although not shown here, the W296A mutation causes an extremely sick or slow growth phenotype in yeast compared to all the other mutants, thus it is perhaps unsurprising W296A has the most edges. 

R46G and G309S mutations were classified as "loading" mutants [@Hohrman2021], for reasons I won't explain here. Our current model of these mutations suggests that each group of mutants are affecting similar processes which cause similar observable phenotypes. Therefore, from the network analysis it seems that R46G and G309S mutations may both impact cellular amino acid metabolic process, but further studies are needed to confirm.

Similarly, the 'closing' mutants: S481Y and A583T may be selectively affecting the response to heat.

The 'Reopening' mutants: K102E, S25P, and Q380K do not appear to be affecting any one particular process as a group, except maybe response to oxidative stress.

Finally, we have our 'miscellaneous' mutants: W296A and G424D. Of which, we already talked about W296A. G424D is in interesting mutation, but from prior studies, this mutation affect Hsp90 function, but according to our proteomic study (not shown here), only 11 proteins were affected in this yeast when this mutation is present. According to our network analysis, it might be worth looking into the cellular amino acid metabolic process with this mutation. However, it is possible the low number of protein hits in this mutant skewed the GO Slim analysis against it and an in depth analysis of this mutation only is in order.

Overall, preliminary network analysis of our proteomic data suggests that some cellular processes maybe differentially affected by one or more mutations in Hsc82 and may be worth pursuing follow-up studies to validate these claims.
