...
1. If one of the issues is the ability to distinguish between players (stacked data points), then why not separate by players? 
```{r}

ggplot(draft2022[draft2022$round == 1,], aes(x= reorder(name, overall), y=NHLgames, group(round))) +
  geom_point(group = name)+
